...
_pa.segments = [{"name":"All visitors","id":1016248,"regex":".*"},{"name":"Existing Parse Customers","id":1305566,"regex":"/apps/?([?#].*)*$"}];
_pa.conversions = [{"name":"Customer Upgrades to Pro","id":"140188","regex":"/plans/success/?([?#].*)*$"},{"name":"Customer Sign Up","id":"140194","regex":"/apps/onboard/?([?#].*)*$"}];
